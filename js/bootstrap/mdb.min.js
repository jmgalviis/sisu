...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    if (!t.jQuery) {
        ...
        i.isWindow = function (t) {
            ...
            if (n) {
                if (s) for (; o > r && (a = i.apply(t[r], n), !1 !== a); r++) ; else for (r in t) if (a = i.apply(t[r], n), !1 === a) break
            } else if (s) for (; o > r && (a = i.call(t[r], r, t[r]), !1 !== a); r++) ; else for (r in t) if (a = i.call(t[r], r, t[r]), !1 === a) break;
            return t
            ...
            for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++) if (null != (r = arguments[l])) for (a in r) t = s[a], n = r[a], s !== n && (d && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, o = t && i.isArray(t) ? t : []) : o = t && i.isPlainObject(t) ? t : {}, s[a] = i.extend(d, o, n)) : void 0 !== n && (s[a] = n));
            return s
    ...
    return function (t, e, i, n) {
        ...
        function o(t, i, n, a) {
            ...
            var c = 4, f = .001, p = 1e-7, g = 10, m = 11, v = 1 / (m - 1), b = "Float32Array" in e;
            if (4 !== arguments.length) return !1;
            for (var y = 0; 4 > y; ++y) if ("number" != typeof arguments[y] || isNaN(arguments[y]) || !isFinite(arguments[y])) return !1;
        ...
        function l(t) {
            if (t) {
                ...
                for (var a = 0; i > a; a++) if (b.State.calls[a]) {
                    var o = b.State.calls[a], s = o[0], h = o[2], c = o[3], f = !!c, g = null;
            ...
            for (var i = b.State.calls[t][0], a = b.State.calls[t][1], o = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, u = 0, h = i.length; h > u; u++) {
                ...
                if (e || o.loop || ("none" === o.display && x.setPropertyValue(c, "display", o.display), "hidden" === o.visibility && x.setPropertyValue(c, "visibility", o.visibility)), !0 !== o.loop && (d.queue(c)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(c)[1])) && r(c)) {
                    ...
                    d.each(x.Lists.transforms3D, function (t, e) {
                        var i = /^scale/.test(e) ? 1 : 0, a = r(c).transformCache[e];
                ...
                }), b(c, "reverse", {loop: !0, delay: o.delay})), !1 !== o.queue && d.dequeue(c, o.queue)
            }
            b.State.calls[t] = !1;
        ...
        if (!(7 >= c)) {
            ...
            var y = function () {
                ...
                return function i(n, a, r) {
                    var o, s, l, u, d, h, c, f, p, g, m, v = {x: -1, v: 0, tension: null, friction: null}, b = [0],
                        y = 0;
            ...
            var x = b.CSS = {
                ...
                Hooks: {
                    templates: {
                        ...
                        var i, n, a;
                        if (c) for (i in x.Hooks.templates) {
                ...
                setPropertyValue: function (t, i, n, a, o) {
                    var s = i;
                    if ("scroll" === i) o.container ? o.container["scroll" + o.direction] = n : "Left" === o.direction ? e.scrollTo(n, o.alternateValue) : e.scrollTo(o.alternateValue, n); else if (x.Normalizations.registered[i] && "transform" === x.Normalizations.registered[i]("name", t)) x.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i]; else {
                        if (x.Hooks.registered[i]) {
            ...
            var w = function () {
                ...
                var o, h, c, f, g, v,
                    y = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || p.isString(arguments[0].properties));
                if (p.isWrapped(this) ? (o = !1, c = 0, f = this, h = this) : (o = !0, c = 1, f = y ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                    ...
                    var M, P = {promise: null, resolver: null, rejecter: null};
                        ...
                        p.isNode(a) && function () {
                            function t(t) {
                                ...
                                function y() {
                                    ...
                                    var s = {};
                                    if (a && n) s.emToPx = _.lastEmToPx, s.percentToPxWidth = _.lastPercentToPxWidth, s.percentToPxHeight = _.lastPercentToPxHeight; else {
                                ...
                                if ("scroll" === M) {
                                    ...
                                    u.container ? p.isWrapped(u.container) || p.isNode(u.container) ? (u.container = u.container[0] || u.container, A = (w = u.container["scroll" + I]) + d(o).position()[I.toLowerCase()] + T) : u.container = null : (w = b.State.scrollAnchor[b.State["scrollProperty" + I]], C = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === I ? "Top" : "Left")]], A = d(o).offset()[I.toLowerCase()] + T), h = {
                                        scroll: {
                                            ...
                                            unitType: "",
                                            easing: u.easing,
                                            scrollData: {container: u.container, direction: I, alternateValue: C}
                                        }, element: o
                                    ...
                                    for (var O in g) {
                                        ...
                                        if (r(o).isSVG || "tween" === B || !1 !== x.Names.prefixCheck(B)[1] || x.Normalizations.registered[B] !== n) {
                                            ...
                                            if (N = (H = m(O, N))[0], q = H[1], z = (H = m(O, z))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return Y = e, ""
                                            }), j = H[1], N = parseFloat(N) || 0, z = parseFloat(z) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(O) ? (z /= 100, j = "em") : /^scale/.test(O) ? (z /= 100, j = "") : /(Red|Green|Blue)$/i.test(O) && (z = z / 100 * 255, j = "")), /[\/*]/.test(Y)) j = q; else if (q !== j && 0 !== N) if (0 === z) j = q; else {
                                                a = a || y();
                            ...
                            var a, o = this, u = d.extend({}, b.defaults, v), h = {};
                    ...
                    }), (V = d.extend({}, b.defaults, v)).loop = parseInt(V.loop), F = 2 * V.loop - 1, V.loop) for (var O = 0; F > O; O++) {
            ...
            return b.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
                ...
                b.Redirects["slide" + e] = function (t, i, a, r, o, s) {
                    var l = d.extend({}, i), u = l.begin, h = l.complete,
                        c = {height: "", marginTop: "", marginBottom: "", paddingTop: "", paddingBottom: ""}, f = {};
                ...
                b.Redirects["fade" + e] = function (t, i, a, r, o, s) {
                    var l = d.extend({}, i), u = {opacity: "In" === e ? 1 : 0}, h = l.complete;
    ...
    return function t(e, i, n) {
        ...
        1: [function (t, e, i) {
            ...
            function a(t) {
                if (t) {
                    var e = [0, 0, 0], i = 1, a = t.match(/^#([a-fA-F0-9]{3})$/);
                    if (a) {
                        a = a[1];
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    dataElementType: t.elements.Rectangle, initialize: function () {
                        ...
                        var a = this.chart, r = this.getMeta(), o = this.getDataset(), s = t.custom || {},
                        ...
                        var n = t._model, a = this.getValueScale(), r = a.getBasePixel(), o = a.isHorizontal(),
                            s = this._ruler || this.getRuler(), l = this.calculateBarValuePixels(this.index, e),
                        ...
                        var t = this.getIndexScale(), i = t.options, n = this.getStackCount(),
                            a = (t.isHorizontal() ? t.width : t.height) / t.ticks.length, r = a * i.categoryPercentage,
                            o = r / n, s = o * i.barPercentage;
                        return {
                            stackCount: n,
                            tickSize: a,
                            categorySize: r,
                        ...
                        var i, n, a, r, o, s, l = this.chart, u = this.getMeta(), d = this.getValueScale(),
                            h = l.data.datasets, c = Number(h[t].data[e]), f = d.options.stacked, p = u.stack, g = 0;
                        if (f || void 0 === f && void 0 !== p) for (i = 0; i < t; ++i) (n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === d.id && l.isDatasetVisible(i) && (a = Number(h[i].data[e]), (c < 0 && a < 0 || c >= 0 && a > 0) && (g += a));
                        ...
                        var n = i.scale, a = this.chart.isCombo, r = this.getStackIndex(t),
                            o = n.getPixelForValue(null, e, t, a), s = i.barSize;
            ...
            e.exports = function (t) {
                ...
                t.defaults.bubble = {
                    ...
                    dataElementType: t.elements.Point, update: function (t) {
                        ...
                        var r = this.getMeta(), o = this.getScaleForId(r.xAxisID), s = this.getScaleForId(r.yAxisID),
                            l = i.custom || {}, u = this.getDataset(), d = u.data[n],
                            h = this.chart.options.elements.point, c = this.index;
                        e.extend(i, {
                            _xScale: o,
                            _yScale: s,
                            _datasetIndex: c,
            ...
            e.exports = function (t) {
                ...
                i.doughnut = {
                        ...
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return i.labels.length && i.datasets.length ? i.labels.map(function (n, a) {
                                    var r = t.getDatasetMeta(0), o = i.datasets[0], s = r.data[a],
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, getRingIndex: function (t) {
                        ...
                        var i = this, n = i.chart, a = n.chartArea, r = n.options, o = r.elements.arc,
                            s = a.right - a.left - o.borderWidth, l = a.bottom - a.top - o.borderWidth,
                            u = Math.min(s, l), d = {x: 0, y: 0}, h = i.getMeta(), c = r.cutoutPercentage,
                            f = r.circumference;
                        if (f < 2 * Math.PI) {
                        ...
                        var a = this.chart, r = a.chartArea, o = a.options, s = o.animation, l = (r.left + r.right) / 2,
                            u = (r.top + r.bottom) / 2, d = o.rotation, h = o.rotation, c = this.getDataset(),
                            ...
                            g = n && s.animateScale ? 0 : this.outerRadius, m = e.getValueAtIndexOrDefault;
                        e.extend(t, {
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    datasetElementType: t.elements.Line, dataElementType: t.elements.Point, update: function (t) {
                        var n, a, r, o = this.getMeta(), s = o.dataset, l = o.data || [], u = this.chart.options,
                            d = u.elements.line, h = this.getScaleForId(o.yAxisID), c = this.getDataset(), f = i(c, u);
                        ...
                        var n = this.chart.options.elements.point.backgroundColor, a = this.getDataset(),
                            r = t.custom || {};
                        ...
                        var n = this.chart.options.elements.point.borderColor, a = this.getDataset(),
                            r = t.custom || {};
                        ...
                        var n = this.chart.options.elements.point.borderWidth, a = this.getDataset(),
                            r = t.custom || {};
                        ...
                        var a, r, o = this.getMeta(), s = t.custom || {}, l = this.getDataset(), u = this.index,
                            d = l.data[i], h = this.getScaleForId(o.yAxisID), c = this.getScaleForId(o.xAxisID),
                        ...
                        if (this.chart.options.elements.line.capBezierPoints) for (t = 0, i = s.length; t < i; ++t) (n = s[t]._model).controlPointPreviousX = l(n.controlPointPreviousX, o.left, o.right), n.controlPointPreviousY = l(n.controlPointPreviousY, o.top, o.bottom), n.controlPointNextX = l(n.controlPointNextX, o.left, o.right), n.controlPointNextY = l(n.controlPointNextY, o.top, o.bottom)
                    }, draw: function () {
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t) {
                                var i = t.data;
                                return i.labels.length && i.datasets.length ? i.labels.map(function (n, a) {
                                    var r = t.getDatasetMeta(0), o = i.datasets[0], s = r.data[a].custom || {},
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, update: function (t) {
                        var i = this, n = i.chart, a = n.chartArea, r = i.getMeta(), o = n.options, s = o.elements.arc,
                        ...
                        var v = o.startAngle, b = t.hidden ? 0 : l.getDistanceFromCenterForValue(r.data[i]),
                            y = v + h * p, x = y + (t.hidden ? 0 : h),
            ...
            e.exports = function (t) {
                ...
                t.defaults.radar = {
                    ...
                    linkScales: e.noop,
                    update: function (t) {
                        var i = this, n = i.getMeta(), a = n.dataset, r = n.data, o = a.custom || {},
                            s = i.getDataset(), l = i.chart.options.elements.line, u = i.chart.scale;
                    ...
                    updateElement: function (t, i, n) {
                        var a = t.custom || {}, r = this.getDataset(), o = this.chart.scale,
                            s = this.chart.options.elements.point, l = o.getPointPositionForValue(i, r.data[i]);
                    ...
                    setHoverStyle: function (t) {
                        var i = this.chart.data.datasets[t._datasetIndex], n = t.custom || {}, a = t._index,
                            r = t._model;
                        ...
                        if (!(isNaN(n) || n <= 0)) {
                            switch (i) {
                                ...
                                case"triangle":
                                    ...
                                    break;
                                case"rect":
                                    h = 1 / Math.SQRT2 * n, e.beginPath(), e.fillRect(a - h, r - h, 2 * h, 2 * h), e.strokeRect(a - h, r - h, 2 * h, 2 * h);
                                    break;
                                case"rectRounded":
                                    var c = n / Math.SQRT2, f = a - c, p = r - c, g = Math.SQRT2 * n;
                                    t.helpers.drawRoundedRectangle(e, f, p, g, g, n / 2), e.fill();
                                    break;
                                case"rectRot":
                                    h = 1 / Math.SQRT2 * n, e.beginPath(), e.moveTo(a - h, r), e.lineTo(a, r + h), e.lineTo(a + h, r), e.lineTo(a, r - h), e.closePath(), e.fill();
                                    break;
                                case"cross":
            ...
            e.exports = function (t) {
                ...
                t.types = {}, t.instances = {}, t.controllers = {}, e.extend(t.prototype, {
                    construct: function (i, a) {
                        ...
                        var l = n.acquireContext(i, a), u = l && l.canvas, d = u && u.height, h = u && u.width;
                        ...
                        var n = this.options, a = this.canvas, r = n.maintainAspectRatio && this.aspectRatio || null,
                            o = Math.floor(e.getMaximumWidth(a)), s = Math.floor(r ? o / r : e.getMaximumHeight(a));
                        ...
                        n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var o = n.options, s = e.getValueOrDefault(o.type, n.dtype),
                                l = t.scaleService.getScaleConstructor(s);
                            if (l) {
                                a(o.position) !== a(n.dposition) && (o.position = n.dposition);
                                var u = new l({id: o.id, options: o, ctx: i.ctx, chart: i});
                        ...
                        }, i), n.length > 1) for (var r = 1; r < n.length; r++) if (n[r] !== n[r - 1]) {
                            i.isCombo = !0;
                            break
                        }
                        return a
                        ...
                        var n = this.getDatasetMeta(t), a = {meta: n, index: t, easingValue: e};
                        ...
                        var i, n = this.options || {}, a = n.hover;
            ...
            "use strict";
            e.exports = function (t) {
                var e = t.helpers, i = ["push", "pop", "shift", "splice", "unshift"];
                ...
                t.DatasetController = function (t, e) {
                    ...
                    datasetElementType: null, dataElementType: null, initialize: function (t, e) {
                        ...
                        var t, a, r = this.getDataset(), o = r.data || (r.data = []);
                    ...
                    }, update: e.noop, transition: function (t) {
                        ...
                        var n = this.chart.data.datasets[t._datasetIndex], a = t._index, r = t.custom || {},
                            o = e.getValueAtIndexOrDefault, s = t._model;
                        ...
                        var i = this.chart.data.datasets[t._datasetIndex], n = t._index, a = t.custom || {},
                            r = e.getValueAtIndexOrDefault, o = e.getHoverColor, s = t._model;
            ...
            e.exports = function (t) {
                ...
                t.elements = {}, t.Element = function (t) {
                    ...
                    initialize: function () {
                        ...
                        var e = this._model, i = this._start, a = this._view;
            ...
            e.exports = function (t) {
                ...
                i.each = function (t, e, n, a) {
                    var r, o;
                    if (i.isArray(t)) if (o = t.length, a) for (r = o - 1; r >= 0; r--) e.call(n, t[r], r); else for (r = 0; r < o; r++) e.call(n, t[r], r); else if ("object" == typeof t) {
                        var s = Object.keys(t);
                    ...
                    for (e = 0; e < c; ++e) if (!(a = h[e]).model.skip) {
                ...
                function s(t, e, i) {
                    var n = document.defaultView, a = t.parentNode, s = n.getComputedStyle(t)[e],
                        l = n.getComputedStyle(a)[e], u = o(s), d = o(l), h = Number.POSITIVE_INFINITY;
                ...
                i.requestAnimFrame = "undefined" == typeof window ? function (t) {
                    ...
                    var n, a, r = t.originalEvent || t, o = t.currentTarget || t.srcElement,
                        s = o.getBoundingClientRect(), l = r.touches;
                    l && l.length > 0 ? (n = l[0].clientX, a = l[0].clientY) : (n = r.clientX, a = r.clientY);
                    var u = parseFloat(i.getStyle(o, "padding-left")), d = parseFloat(i.getStyle(o, "padding-top")),
                        h = parseFloat(i.getStyle(o, "padding-right")), c = parseFloat(i.getStyle(o, "padding-bottom")),
                        f = s.right - s.left - u - h, p = s.bottom - s.top - d - c;
                    return {
                    ...
                    var e = t.parentNode, n = parseInt(i.getStyle(e, "padding-left"), 10),
                        a = parseInt(i.getStyle(e, "padding-right"), 10), r = e.clientWidth - n - a,
                        o = i.getConstraintWidth(t);
                    return isNaN(o) ? r : Math.min(r, o)
                }, i.getMaximumHeight = function (t) {
                    var e = t.parentNode, n = parseInt(i.getStyle(e, "padding-top"), 10),
                        a = parseInt(i.getStyle(e, "padding-bottom"), 10), r = e.clientHeight - n - a,
            ...
            e.exports = function (t) {
                ...
                t.Interaction = {
                    modes: {
                        ...
                        }, label: o, index: o, dataset: function (t, e, n) {
            ...
            e.exports = function (t) {
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        if (t) {
                            var o = t.options.layout, s = o ? o.padding : null, l = 0, u = 0, d = 0, h = 0;
                            isNaN(s) ? (l = s.left || 0, u = s.right || 0, d = s.top || 0, h = s.bottom || 0) : (l = s, u = s, d = s, h = s);
                            var c = i(t.boxes, "left"), f = i(t.boxes, "right"), p = i(t.boxes, "top"),
                                g = i(t.boxes, "bottom"), m = i(t.boxes, "chartArea");
                            n(c, !0), n(f, !1), n(p, !0), n(g, !1);
                            var v = a - l - u, b = r - d - h, y = b / 2, x = (a - v / 2) / (c.length + f.length),
                                w = (r - y) / (p.length + g.length), k = v, S = b, C = [];
                        ...
                        function N(t) {
                            ...
                            if (i) if (t.isHorizontal()) {
                                var n = {left: Math.max(T, M), right: Math.max(D, P), top: 0, bottom: 0};
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.plugins = {}, t.plugins = {
                    _plugins: [], _cacheId: 0, register: function (t) {
                        ...
                        var a = [], r = [], o = i && i.config || {}, s = t.defaults.global.plugins,
            ...
            e.exports = function (t) {
                ...
                function n(i) {
                    var n = e.getValueOrDefault, a = t.defaults.global, r = n(i.fontSize, a.defaultFontSize),
                        o = n(i.fontStyle, a.defaultFontStyle), s = n(i.fontFamily, a.defaultFontFamily);
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var t = this.ctx, i = this.options.ticks, a = n(i);
                        t.font = a.font;
                        var r = i.minRotation || 0;
                        if (this.options.display && this.isHorizontal()) for (var o, s = e.longestText(t, a.font, this.ticks, this.longestTextCache), l = s, u = this.getPixelForTick(1) - this.getPixelForTick(0) - 6; l > u && r < i.maxRotation;) {
                            var d = e.toRadians(r);
                    ...
                    fit: function () {
                        var t = this.minSize = {width: 0, height: 0}, a = this.options, r = a.ticks, o = a.scaleLabel,
                            s = a.gridLines, l = a.display, u = this.isHorizontal(), d = n(r), h = 1.5 * n(o).size,
                        ...
                        if (t.width = u ? this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth : l && s.drawTicks ? c : 0, t.height = u ? l && s.drawTicks ? c : 0 : this.maxHeight, o.display && l && (u ? t.height += h : t.width += h), r.display && l) {
                            var f = e.longestText(this.ctx, d.font, this.ticks, this.longestTextCache),
                                p = e.numberOfLabelLines(this.ticks), g = .5 * d.size;
                            if (u) {
                                this.longestLabelWidth = f;
                                var m = e.toRadians(this.labelRotation), v = Math.cos(m),
                                    b = Math.sin(m) * f + d.size * p + g * p;
                                t.height = Math.min(this.maxHeight, t.height + b), this.ctx.font = d.font;
                                var y = this.ticks[0], x = i(this.ctx, y, d.font),
                                    w = this.ticks[this.ticks.length - 1], k = i(this.ctx, w, d.font);
                    ...
                    draw: function (i) {
                        ...
                        if (r.display) {
                            var o, s, l = a.ctx, u = t.defaults.global, d = r.ticks, h = r.gridLines, c = r.scaleLabel,
                                f = 0 !== a.labelRotation, p = d.autoSkip, g = a.isHorizontal();
                            d.maxTicksLimit && (s = d.maxTicksLimit);
                            var m = e.getValueOrDefault(d.fontColor, u.defaultFontColor), v = n(d),
                                b = h.drawTicks ? h.tickMarkLength : 0,
                                y = e.getValueOrDefault(c.fontColor, u.defaultFontColor), x = n(c),
                                w = e.toRadians(a.labelRotation), k = Math.cos(w), S = a.longestLabelWidth * k;
                            l.fillStyle = m;
                            var C = [];
                            if (g) {
                                if (o = !1, (S + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (o = 1 + Math.floor((S + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), s && a.ticks.length > s) for (; !o || a.ticks.length / (o || 1) > s;) o || (o = 1), o += 1;
                                p || (o = !1)
                            }
                            ...
                            if (e.each(a.ticks, function (t, n) {
                                ...
                                if (h.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), h.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), d.display) {
                                    ...
                                    var i = t.label;
                                    if (e.isArray(i)) for (var n = 0, a = 0; n < i.length; ++n) l.fillText("" + i[n], 0, a), a += 1.5 * v.size; else l.fillText(i, 0, 0);
                                    l.restore()
                                }
                            }), c.display) {
                                var T, D, F = 0;
                ...
                t.Ticks = {
                    generators: {
                        linear: function (t, i) {
                            ...
                            var n, a, r = [], o = e.getValueOrDefault,
                                s = o(t.min, Math.pow(10, Math.floor(e.log10(i.min)))), l = Math.floor(e.log10(i.max)),
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var t = this._options.callbacks, e = t.beforeTitle.apply(this, arguments),
                            i = t.title.apply(this, arguments), a = t.afterTitle.apply(this, arguments), r = [];
                        ...
                        var t = this._options.callbacks, e = t.beforeFooter.apply(this, arguments),
                            i = t.footer.apply(this, arguments), a = t.afterFooter.apply(this, arguments), r = [];
                        return r = n(r = n(r = n(r, e), i), a)
                    }, update: function (i) {
                        var n, r, o, s, l, u, d, h, c, f, p, g, m, v, b, y, x, w, k, S = this, C = S._options,
                            M = S._model, P = S._model = a(C), A = S._active, I = S._data,
                            T = {xAlign: M.xAlign, yAlign: M.yAlign}, D = {x: M.x, y: M.y},
                            F = {width: M.width, height: M.height}, V = {x: M.caretX, y: M.caretY};
                        if (A.length) {
                            P.opacity = 1;
                            var _ = [];
                            ...
                            C.filter && (L = L.filter(function (t) {
                                ...
                                var p = t._options;
                                return {xAlign: p.xAlign ? p.xAlign : d, yAlign: p.yAlign ? p.yAlign : h}
                            }(this, F = function (t, i) {
                                var n = t._chart.ctx, a = 2 * i.yPadding, r = 0, o = i.body,
                                    s = o.reduce(function (t, e) {
                                        return t + e.before.length + e.lines.length + e.after.length
                                    }, 0);
                                s += i.beforeBody.length + i.afterBody.length;
                                var l = i.title.length, u = i.footer.length, d = i.titleFontSize, h = i.bodyFontSize,
                                    c = i.footerFontSize;
                        ...
                        if ("center" === c) s = p + m / 2, "left" === h ? (a = (n = f) - u, r = n, o = s + u, l = s - u) : (a = (n = f + g) + u, r = n, o = s - u, l = s + u); else if ("left" === h ? (n = (a = f + d + u) - u, r = a + u) : "right" === h ? (n = (a = f + g - d - u) - u, r = a + u) : (n = (a = f + g / 2) - u, r = a + u), "top" === c) s = (o = p) - u, l = o; else {
                            s = (o = p + m) + u, l = o;
                            var v = r;
                            r = n, n = v
                        }
                        ...
                        var o = e.xAlign, s = e.yAlign, l = t.x, u = t.y, d = a.width, h = a.height, c = e.cornerRadius;
                    ...
                    average: function (t) {
                        ...
                        for (a = 0, r = t.length; a < r; ++a) {
                            var u = t[a];
                            if (u && u.hasValue()) {
                                var d = u.getCenterPoint(), h = e.distanceBetweenPoints(i, d);
                                h < l && (l = h, n = u)
                            }
                        }
                        if (n) {
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        var t, n, a, r, o = this._view, s = this._chart.ctx, l = o.spanGaps, u = this._children.slice(),
                            d = i.elements.line, h = -1;
            ...
            e.exports = function (t) {
                ...
                i.elements.point = {
                    ...
                    inRange: function (t, e) {
                        ...
                        var r = this._view, o = this._model, s = this._chart.ctx, l = r.pointStyle, u = r.radius,
                            d = r.x, h = r.y, c = t.helpers.color, f = 0;
                    ...
                    draw: function () {
                        ...
                        if (l.horizontal ? (t = l.base, e = l.x, i = l.y - l.height / 2, n = l.y + l.height / 2, a = e > t ? 1 : -1, r = 1, o = l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, i = l.y, a = 1, r = (n = l.base) > i ? 1 : -1, o = l.borderSkipped || "bottom"), u) {
                            var d = Math.min(Math.abs(t - e), Math.abs(i - n)), h = (u = u > d ? d : u) / 2,
                                ...
                                p = i + ("top" !== o ? h * r : 0), g = n + ("bottom" !== o ? -h * r : 0);
            ...
            e.exports = function (t) {
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (e, i) {
                        var s, l, u, d, h, c, f, p = (e.data.datasets || []).length, g = i.propagate, m = [];
                        ...
                        var n = i.meta.$filler;
                        if (n) {
                            var a = n.el, r = a._view, o = a._children || [], u = n.mapper,
                                d = r.backgroundColor || e.global.defaultColor;
                            u && d && o.length && function (t, e, i, n, a, r) {
                                var o, u, d, h, c, f, p, g = e.length, m = n.spanGaps, v = [], b = [], y = 0, x = 0;
            ...
            e.exports = function (t) {
                ...
                return t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                    ...
                    }, beforeUpdate: n, update: function (t, e, i) {
                        ...
                        var i = this, n = i.options, r = n.labels, o = n.display, s = i.ctx, l = t.defaults.global,
                            u = e.getValueOrDefault, d = u(r.fontSize, l.defaultFontSize),
                            h = u(r.fontStyle, l.defaultFontStyle), c = u(r.fontFamily, l.defaultFontFamily),
                            f = e.fontString(d, h, c), p = i.legendHitBoxes = [], g = i.minSize, m = i.isHorizontal();
                        if (m ? (g.width = i.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = i.maxHeight), o) if (s.font = f, m) {
                        ...
                        var i = this, n = i.options, r = n.labels, o = t.defaults.global, s = o.elements.line,
                            l = i.width, u = i.lineWidths;
                        if (n.display) {
                            var d, h = i.ctx, c = e.getValueOrDefault, f = c(r.fontColor, o.defaultFontColor),
                                p = c(r.fontSize, o.defaultFontSize), g = c(r.fontStyle, o.defaultFontStyle),
                                m = c(r.fontFamily, o.defaultFontFamily), v = e.fontString(p, g, m);
                            ...
                            e.each(i.legendItems, function (e, a) {
                                var f, g, m, v, k = h.measureText(e.text).width, S = b + p / 2 + k, C = d.x, M = d.y;
                        ...
                        var e = this.options, i = "mouseup" === t.type ? "click" : t.type, n = !1;
                        if ("mousemove" === i) {
                            if (!e.onHover) return
                        } else {
                            if ("click" !== i) return;
                        ...
                        var a = t.x, r = t.y;
                        if (a >= this.left && a <= this.right && r >= this.top && r <= this.bottom) for (var o = this.legendHitBoxes, s = 0; s < o.length; ++s) {
                            var l = o[s];
            ...
            e.exports = function (t) {
                ...
                return t.defaults.global.title = {
                    ...
                    beforeFit: n,
                    fit: function () {
                        var i = e.getValueOrDefault, n = this.options, a = t.defaults.global, r = n.display,
                            o = i(n.fontSize, a.defaultFontSize), s = this.minSize;
                    ...
                    draw: function () {
                        var i = this.ctx, n = e.getValueOrDefault, a = this.options, r = t.defaults.global;
                        if (a.display) {
                            var o, s, l, u = n(a.fontSize, r.defaultFontSize), d = n(a.fontStyle, r.defaultFontStyle),
                                h = n(a.fontFamily, r.defaultFontFamily), c = e.fontString(u, d, h), f = 0,
                                p = this.top, g = this.left, m = this.bottom, v = this.right;
            ...
            e.exports = function (t) {
                var e = t.helpers, i = t.Scale.extend({
                    getLabels: function () {
                        ...
                        var a,
                            r = Math.max(this.maxIndex + 1 - this.minIndex - (this.options.gridLines.offsetGridLines ? 0 : 1), 1);
                        ...
                        var e = Math.max(this.ticks.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1),
                            i = this.isHorizontal(), n = (i ? this.width : this.height) / e;
            ...
            "use strict";
            e.exports = function (t) {
                var e = t.helpers, i = {position: "left", ticks: {callback: t.Ticks.formatters.linear}},
                    n = t.LinearScaleBase.extend({
                        determineDataLimits: function () {
                            ...
                            if (this.isHorizontal()) i = Math.min(n.maxTicksLimit ? n.maxTicksLimit : 11, Math.ceil(this.width / 50)); else {
                            ...
                            var e, i = this.start, n = +this.getRightValue(t), a = this.end - i;
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        var t = this.options.ticks;
                        if (t.beginAtZero) {
                            var i = e.sign(this.min), n = e.sign(this.max);
                    ...
                    }, getTickLimit: i, handleDirectionalChanges: i, buildTicks: function () {
                        var i = this.options.ticks, n = this.getTickLimit(), a = {
            ...
            "use strict";
            e.exports = function (t) {
                var e = t.helpers, i = {position: "left", ticks: {callback: t.Ticks.formatters.logarithmic}},
                    n = t.Scale.extend({
                        determineDataLimits: function () {
                            var t = this, i = t.options, n = i.ticks, a = t.chart, r = a.data.datasets,
                                o = e.getValueOrDefault, s = t.isHorizontal();
                            ...
                            var i = this.options.ticks, n = {min: i.min, max: i.max},
                            ...
                            var i, n, a, r = this.start, o = +this.getRightValue(t), s = this.options.ticks;
            ...
            e.exports = function (t) {
                ...
                function r(t) {
                    var n = t.options.pointLabels, a = e.getValueOrDefault(n.fontSize, i.defaultFontSize),
                ...
                function s(t, i, n, a) {
                    if (e.isArray(i)) for (var r = n.y, o = 1.5 * a, s = 0; s < i.length; ++s) t.fillText(i[s], n.x, r), r += o; else t.fillText(i, n.x, n.y)
                }
                ...
                var u = t.LinearScaleBase.extend({
                    setDimensions: function () {
                        ...
                        this.options.pointLabels.display ? function (t) {
                            var i, n, s, l = r(t), u = Math.min(t.height / 2, t.width / 2),
                            ...
                            for (i = 0; i < g; i++) {
                                ...
                                } : {w: c.measureText(p).width, h: f}, t._pointLabelSizes[i] = n;
                                var m = t.getIndexAngle(i), v = e.toDegrees(m) % 360, b = o(v, s.x, n.w, 0, 180),
                        ...
                        var a = this.width - e - this.drawingArea, r = t + this.drawingArea, o = i + this.drawingArea,
                        ...
                        if (n.display) {
                            var d = t.ctx, h = u(l.fontSize, i.defaultFontSize), c = u(l.fontStyle, i.defaultFontStyle),
                                f = u(l.fontFamily, i.defaultFontFamily), p = e.fontString(h, c, f);
                            e.each(t.ticks, function (r, s) {
                                if (s > 0 || n.reverse) {
                                    var c = t.getDistanceFromCenterForValue(t.ticksAsNumbers[s]), f = t.yCenter - c;
                                ...
                                var n = t.ctx, o = e.getValueOrDefault, l = t.options, u = l.angleLines,
                                    d = l.pointLabels;
            ...
            n = "function" == typeof n ? n : window.moment, e.exports = function (t) {
                ...
                var r = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, i = this, n = i.options.time, r = Number.MAX_SAFE_INTEGER, o = Number.MIN_SAFE_INTEGER,
                            s = i.chart.data, l = {labels: [], datasets: []};
                        ...
                        var n, r, o = this.options.time, s = this.dataMin, l = this.dataMax;
                        if (o.min) {
                            var u = a(this, o.min);
                            o.round && u.round(o.round), n = u.valueOf()
                        }
                        o.max && (r = a(this, o.max).valueOf());
                        var d = this.getLabelCapacity(n || s), h = o.unit || function (t, e, n, a) {
                        ...
                        var c = o.stepSize || function (t, e, n, a) {
                            ...
                            if (r.steps) for (var d = r.steps.length, h = 0; h < d && s > a; h++) l = r.steps[h], s = Math.ceil(u / (o * l)); else for (; s > a && a > 0;) ++l, s = Math.ceil(u / (o * l));
                            return l
                        }(n || s, r || l, h, d);
                        ...
                        }, {min: s, max: l}), this.max = e.max(this.ticks), this.min = e.min(this.ticks)
                    }, getLabelForIndex: function (t, e) {
                        ...
                        var n = this.options.ticks, a = this.ctx.measureText(i).width,
                            r = Math.cos(e.toRadians(n.maxRotation)), o = Math.sin(e.toRadians(n.maxRotation));
...
$(window).scroll(function () {
    ...
    function o(t) {
        var e, i, n, a, r = {top: 0, left: 0}, o = t && t.ownerDocument;
    ...
    var l = {
        duration: 750, delay: 200, show: function (t, e, i) {
            ...
            var d = "scale(" + e.clientWidth / 100 * 3 + ")", h = "translate(0,0)";
    ...
    return t.init = function (t) {
        ...
        var i = (t = r(t)).length;
        if ((e = e || {}).wait = e.wait || 0, e.position = e.position || null, i) for (var n, a, s, u = {}, d = 0, h = {
            type: "mousedown",
            button: 1
        }, c = function (t, e) {
            return function () {
